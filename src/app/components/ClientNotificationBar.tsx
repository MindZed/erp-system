// src/app/components/ClientNotificationBar.tsx
...
export default function ClientNotificationBar({ status, name, message, action }: NotificationProps) {
    ...
    const generateContent = () => {
        ...
        if (status === 'success') {
            if (action === 'deleted') {
                return `Success: User ${userName} has been permanently deleted.`;
            } else if (action === 'updated') {
                 return `Success: User ${userName} updated successfully.`;
            } else if (action === 'created') {
                return `Success: New user ${userName} created successfully.`;
            }
